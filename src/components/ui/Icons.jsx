...
export const IconDiamond = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2 22 12l-10 10L2 12 12 2z" />
  </svg>
);
...
export const IconCollapse = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconPin = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 0 1 0-5 2.5 2.5 0 0 1 0 5z" />
  </svg>
);

export const IconCoins = ({ className = "w-12 h-12" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M10 36v8c0 3.3 6.3 6 14 6s14-2.7 14-6v-8" />
...
export const IconLogo = ({ className = "w-7 h-7" }) => (
  // Simbolo "■" del brand Externalytics
  <svg className={className} viewBox="0 0 28 28" fill="currentColor">
    <rect x="2" y="2" width="24" height="24" />
  </svg>
);

export const IconDecorDiamond = ({ className = "w-12 h-12" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none">
    <rect x="20" y="4" width="14" height="14" fill="#0E0E10" transform="rotate(45 27 11)" />
    <rect x="32" y="16" width="18" height="18" fill="#A3A3AA" transform="rotate(45 41 25)" />
    <rect x="14" y="30" width="22" height="22" fill="#0E0E10" transform="rotate(45 25 41)" />
    <rect x="36" y="38" width="14" height="14" fill="#A3A3AA" transform="rotate(45 43 45)" />
  </svg>
);
